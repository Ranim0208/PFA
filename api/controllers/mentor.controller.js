...
export const createMentorProfile = async (req, res) => {
  try {
    ...
    // Automatically set email from the logged-in user if not provided in the payload
    if (!personalInfo.email && req.user.email) {
    ...
    // Find mentor profile or create a new one
...
export const updateMentorProfile = async (req, res) => {
  try {
    ...
    const updateData = {
      personalInfo: {
        ...existingMentor.personalInfo, // Preserve existing info like cv and idDocument
        ...personalInfo, // Add new info
      },
