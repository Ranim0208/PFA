...
import { notifyNewTrainingOutput } from "../services/notificationService.js";
...
export const createTrainingOutput = async (req, res) => {
  try {
    ...
    // Notification push pour les porteurs de projets (en arrière-plan)
    notifyNewTrainingOutput(savedOutput, training).catch((err) =>
      console.error("❌ Erreur notification livrable:", err),
    );
